...
const items = [
  {
    ...
    desc: 'Chaque outil est analysé selon des critères précis : fonctionnalités, prix, limites, support et pertinence selon le profil.',
  },
  {
    icon: <Star className="w-6 h-6 text-yellow-500" />,
    bg: 'bg-yellow-50 border-yellow-100',
    title: 'Notes éditoriales',
    desc: 'Les notes reflètent une analyse éditoriale des fonctionnalités, limites, prix et cas d’usage. Elles ne sont pas présentées comme des avis utilisateurs.',
  },
  {
...
const TRUST_STATS = [
  { value: '100+', label: 'Outils analysés' },
  { value: '5', label: 'Catégories' },
  { value: 'Éditorial', label: 'Notation' },
  { value: '2026', label: 'Guides mis à jour' },
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-lg">
            Chaque outil est analysé avec une grille lisible pour aider les visiteurs à comparer sans perdre de temps.
          </p>
        </div>
