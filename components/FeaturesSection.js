...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Chaque fiche rassemble les fonctionnalités, prix, limites, cas d’usage, documentation disponible et tests lorsque c’est possible.",
  ...
  },
  {
    ...
    desc: "Une note lisible basée sur des critères concrets : fonctionnalités, prix, facilité d’usage, limites, support et pertinence selon le profil.",
  ...
  },
  {
    ...
    desc: "Les fiches sont mises à jour lorsque les prix, offres, fonctionnalités ou alternatives changent de façon importante.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Pas de sélection au hasard : chaque outil est présenté avec les critères qui aident vraiment à décider.
          </p>
        </div>
