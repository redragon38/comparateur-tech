    ...
    <>
      ...
      >
        <nav className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Burger mobile */}
            <button
              className="md:hidden text-gray-700 hover:text-purple-700 transition-colors duration-200 p-2 rounded-lg hover:bg-purple-50 active:scale-95"
      ...
      >
        <div className="px-4 pt-4 pb-8 space-y-1">
          <Link href="/" onClick={closeMobile} className="block text-gray-700 hover:text-purple-700 px-3 py-2.5 rounded-xl hover:bg-purple-50 text-sm font-medium transition-all duration-150">Accueil</Link>
          <Link href="/outils" onClick={closeMobile} className="block text-gray-700 hover:text-purple-700 px-3 py-2.5 rounded-xl hover:bg-purple-50 font-semibold text-sm transition-all duration-150">🛠️ Tous les outils</Link>
          ...
          <Link href="/partenaires" onClick={closeMobile} className="block text-gray-700 hover:text-purple-700 px-3 py-2.5 rounded-xl hover:bg-purple-50 text-sm transition-all duration-150">🤝 Partenaires</Link>
