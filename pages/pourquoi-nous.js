...
const STEPS = [
  ...
  { num: '02', icon: '🧪', title: 'Analyse structurée', desc: "Chaque fiche rassemble fonctionnalités, prix, limites, documentation disponible et tests lorsque c’est possible." },
  { num: '03', icon: '📊', title: 'Note éditoriale', desc: 'On attribue une note éditoriale basée sur des critères concrets : fonctionnalités, prix, support, interface et limites.' },
  { num: '04', icon: '✅', title: 'Publication & mise à jour', desc: 'Les fiches sont ajustées lorsque les offres, prix, limites ou alternatives évoluent fortement.' },
];

const VALUES = [
  { icon: '🔒', title: 'Indépendance éditoriale', desc: 'Nos recommandations restent éditoriales. Si certains liens deviennent affiliés plus tard, cela ne doit pas changer le verdict.' },
  ...
  { icon: '⚡', title: 'Mise à jour continue', desc: 'Le marché évolue vite. On met à jour les fiches lorsque les informations importantes changent : prix, offres, limites ou alternatives.' },
